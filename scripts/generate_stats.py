...
Env:
  ...
  GH_LOGIN      user to summarise (default: dhruvrnkoti)
...
def main():
    ...
    login = os.environ.get("GH_LOGIN", "dhruvrankoti")
    out_dir = os.environ.get("OUT_DIR", "img")
    # Ensure output directory exists (default: img/)
